...
.PARAMETER To
	...
	If SmtpServer is used, this is a required parameter.
.EXAMPLE
	PS C:\PSScript > .\PVS_Inventory_V6.ps1
...
.EXAMPLE
	PS C:\PSScript > .\PVS_Inventory_V6.ps1 -Text

	Saves the document as a formatted text file.
	The computer running the script for the AdminAddress.
.EXAMPLE
	PS C:\PSScript > .\PVS_Inventory_V6.ps1 -HTML

	Saves the document as an HTML file.
	The computer running the script for the AdminAddress.
.EXAMPLE
	PS C:\PSScript > .\PVS_Inventory_V6.ps1 -Hardware 
	
	Creates an HTML report with hardware information for the PVS servers.
	The computer running the script for the AdminAddress.
.EXAMPLE
	PS C:\PSScript .\PVS_Inventory_V6.ps1 -CompanyName "Carl Webster Consulting" 
...
.EXAMPLE
	PS C:\PSScript .\PVS_Inventory_V6.ps1 -CN "Carl Webster Consulting" -CP "Mod" 
...
.EXAMPLE
	PS C:\PSScript > .\PVS_Inventory_V6.ps1 -StartDate "01/01/2022" -EndDate "01/31/2022" 
...
.EXAMPLE
	PS C:\PSScript > .\PVS_Inventory_V6.ps1 -StartDate "01/01/2022 10:00:00" -EndDate 
	"01/31/2022 14:00:00" 
	...
	PM.
.EXAMPLE
	PS C:\PSScript > .\PVS_Inventory_V6.ps1 -Folder \\FileServer\ShareName
...
.EXAMPLE
	PS C:\PSScript >.\PVS_Inventory_V6.ps1 -Dev -ScriptInfo -Log
...
# AgEAAgEAAgEAAgEAAgEAMCEwCQYFKw4DAhoFAAQUNbft7DUYeIw2nuZe99zlTYWx
# LhqggiaxMIIFjTCCBHWgAwIBAgIQDpsYjvnQLefv21DiCEAYWjANBgkqhkiG9w0B
...
# BgEEAYI3AgEEMCMGCSqGSIb3DQEJBDEWBBQX82Cd0A3Dd20AEuOTXQKEyksLPzAN
# BgkqhkiG9w0BAQEFAASCAgCqblUS+LQr4TrtPIQKq9g+PxfW54SxEOVZa3M6swkn
# JxL4UJ30WCfDSelZk23HYW9lpceMftvsw67L0egzWXrZgYF10GAHuqpK5ERIUGyR
# kB5lyFmGB2LjSk7mdTNRXabLRQwpXN5p+QLEdUEsTg+SF1mW/rHbi+/evbnomqTE
# FllGhfIuMq+AER2a71lii0U1QoF36PmiHo7Q+dpJt8ylaxf5V60BViPYd1qfHwMB
# fu24a0EQpwNJ9FQybULFIIdCgaPCl3T+UuQPxSlWC15uw+07ZBykU34+h7ZZreRH
# Tj9oN1av33DNq4AjClQriEr+e33QswnV921Z5TgnVJfrENma4XGSeJBlJOhMeGwP
# LdcxMyupAVG1oxSZtS4FfOh1AG3Bz8pHsX56lSY8mbgV8UJbY1tdPXRsB5wOC1my
# VwyaoEhdFR7yVt3nC7btOBu4NhZE6M5dRnw0rDRhWfDR9Kg7LydMkbKjzU9ypMYg
# cXJsLsCDwN6BYN7lx56xuThdkLC0lseksQzvsEfvLFiRY8iFoDlnb7dDMrHL4o58
# toNkfap6wfnqlisqn3t0WOorH8VRCGlZuEgf5qFyn3YKfIN6yE+XslWUXkDANIE4
# uh+H+T9SLyfdsxhZ7hIGND8c/b/hAWJtmbeZ+lWQQ27VyHDiv+C4HvSO+KUi9evo
# ZKGCAyAwggMcBgkqhkiG9w0BCQYxggMNMIIDCQIBATB3MGMxCzAJBgNVBAYTAlVT
...
# AQcBMBwGCSqGSIb3DQEJBTEPFw0yMzA0MTcxNzMxMzJaMC8GCSqGSIb3DQEJBDEi
# BCAWgVvSGJZGqPvlZ363D5Ss9rlJ+ii2xg1r8k8hQwHINDANBgkqhkiG9w0BAQEF
# AASCAgBBPSiQUOXjyKN0tpobn4eRioYp31m363ZYEGt6XqpGlUcHvE+s/xtIMfMy
# JuhefG9ddbk5baaMa+jGuua4dgQ57I3WIeAqEsVETWhbONzd/Ip5X/njyDzIdLRq
# SSxF5BRfaxMnovOK1Ilig/OdfjZXHk6Ol1ShjCrb9Y3RYWa/qB53ZcTydCiKanyB
# LWURcu4HRhBQxwzLM9M9H4HjTuyHx33kOVhE5iI3jDMjYkAe3tIIaWb8Os1/qKO1
# 5OHPwMqOovb8vjJfOEPhXKnHg4rv5zf/LUM3A3so36LkizkB1MORDPFYp8I9ZV/c
# gST0hZqOUKA7EVamq0X7XVHrBlmVry+beXCtfgZiiWBTTm562qbJVwVu1JCalfBv
# 3ZFCbhoY0qI7dwYPlBKYbHYTyxbTlQ3tLtXvwHembuKEhgRaX/YV8dfFOpRtLVk0
# Ng7mxcY9YKGmfKZKOv/lTAbXdaXHbXOY3efHyt3zsfngTaLeGNVJagNCZTKbNqth
# zRGGqqcYC6UEC/PclEelwDeQntSm+7OsEwtDXRf94Mz0yHyy/reOOtnHBWRyQrc3
# si6yrD3Ky6FICejlNdIW+m34t9GkyL7ERBq/S/m8GjAq1YNSUOiFVmZHiSoOq5jc
# sjyQQKZ+4urMVdA+78msj2ZYfyEkcaTK8nM3M+iqIp24Z/pccQ==
